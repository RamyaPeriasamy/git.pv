                    ...
                    if ($exception != 25) {
                        if ($anyArgs) {
							...
							// Amplus Raisoni3 Nagpur start
								...
								echo '<a href="amplusExport.php?stamp='.$stamp.'&endstamp='.$endstamp.'&park_no='.$park_no.'&phase=' . $phase .'&args=0,1,2,3&args=0,1,0,10151,System_PR,System PR,15,%,1;0,1,0,10452,En_irradiation,Irradiation,15,W/m&sup2;,\'Gold\';0,1,0,10452,Energy_Module_Temp,Module Temperature,15,&deg;C,\'darkred\'">';
								echo '    <img title="Export Meter data as .csv file" src="../imgs/xls.png">';
								echo '</a>';
							}
